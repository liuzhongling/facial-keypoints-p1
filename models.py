...
class CNN1(nn.Module):
    ...
    def __init__(self):
        ...
        # ELUs(128, 53, 53)-> pool (128, 26, 26)-> dropout(0.4)(128, 26, 26)
        self.dropout3 = nn.Dropout(p=0.4)
        
        # faltten 256*12*12 -> 2000 -> Relu -> dropout (0.4)
        self.fc1 = nn.Linear(128*26*26, 2000, bias=True)
        I.kaiming_uniform_(self.fc1.weight)
        I.constant(self.fc1.bias, 0.1)
        self.dropout5 = nn.Dropout(p=0.4)
        # Relu => dropout with 0.4
        
        self.fc2 = nn.Linear(2000, 2000, bias=True)
        self.dropout6 = nn.Dropout(p=0.4)
        I.kaiming_uniform_(self.fc2.weight)
        I.constant(self.fc2.bias, 0.1)
        # finally, create 68 * 2 output keypoints
        self.fc3 = nn.Linear(2000, 68*2)
        I.kaiming_uniform_(self.fc3.weight)
        I.constant(self.fc3.bias, 0.1)
...
class Net8(nn.Module):
    ...
    def __init__(self):
        ...
        # RLU(256, 26, 26)-> pool (256, 13, 13)-> dropout(0.4)(256, 13, 13)
        # faltten 256*12*12 -> 2000 -> Relu -> dropout (0.4)
